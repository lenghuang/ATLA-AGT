...
const Title = () => {
    return (
        <div className="title">
            ...
            <i><h4> Mathematical notations, definitions, and explanations
                    for your class game theory ideas. </h4></i>
        </div>);
}
...
function Theory() {
  return (
    <div className="central-card">
        ...
        <div className="content">
            <ReactMarkdown plugins={[gfm]}>### Elemental Hierarchy</ReactMarkdown>
            <div style={{textAlign: "center"}}><span>
                <img src={edChars} alt="drawing" height="400"/>
                <img src={edNames} alt="drawing" height="400"/>
            </span></div>
            <ReactMarkdown plugins={[gfm]}>
                {elements}
            </ReactMarkdown>
